    ...
    class ScalabilityVisitor(ast.NodeVisitor):
        ...
        def visit_Import(self, node):
            for alias in node.names:
                ...
                if any(keyword in alias.name for keyword in caching_keywords): self.uses_caching_libs = True
        ...
        def visit_ImportFrom(self, node):
            if node.module:
                ...
                if any(keyword in node.module for keyword in caching_keywords): self.uses_caching_libs = True
            self.generic_visit(node)
